...
var _air_tex: CompressedTexture2D = preload("res://_utests_and_debug_instruments/assets/air.png")
...
var _finish_tex: CompressedTexture2D = preload("res://_utests_and_debug_instruments/assets/finish.png")
var _destr_tex: CompressedTexture2D = preload("res://_utests_and_debug_instruments/assets/destructable.png")
...
func _update_grid(template: Array[Cell.cell_type]) -> void:
	...
	if(template[4] ==  Cell.cell_type.ENEMY):
		...
		_array_grid[4].size_flags_stretch_ratio = 2.09
